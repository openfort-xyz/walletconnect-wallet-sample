...
export interface TestAggregatedWalletInterface extends utils.Interface {
  functions: {
...
export interface TestAggregatedWallet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestAggregatedWalletInterface;
