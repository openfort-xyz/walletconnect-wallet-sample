...
export interface VerifyingPaymaster extends BaseContract {
  ...
  functions: {
    POST_OP_GAS(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    POST_OP_GAS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
