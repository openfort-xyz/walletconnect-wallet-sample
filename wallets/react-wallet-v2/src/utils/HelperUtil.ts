import { EIP4337_CHAINS, TEIP4337Chain } from '@/data/EIP4337Data'
 ...
 */
export function isEIP4337Chain(chain: string) {
  return chain.includes('eip155') || chain.includes('eip4337')
}
...
export function formatChainName(chainId: string) {
  return (
    EIP4337_CHAINS[chainId as TEIP4337Chain]?.name ??
